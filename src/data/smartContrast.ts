// The frozen-vs-improving contrast rows — single source of truth, rendered by
// SmartWebsiteConcept (on /plans) and the homepage "AI-Powered Websites"
// versus panel. Same honesty rule as everywhere: every capability is
...
export const ourSites = [
  ...
  'Structured so ChatGPT and Google’s AI can read, quote, and recommend you.',
];
