...
export const SERVICE_TYPES: ServiceType[] = [
  { value: 'website-basic', label: 'Get Found ($249/mo)' },
  { value: 'website-plus', label: 'Get Booked ($399/mo)' },
  { value: 'website-smart', label: 'Get Growing ($599/mo)' },
  { value: 'get-ahead', label: 'Get Ahead ($999/mo)' },
  { value: 'ecommerce', label: 'Sell Online ($499/mo)' },
