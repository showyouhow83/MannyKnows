...
export const localAreas: LocalArea[] = [
  ...
  },
  {
    ...
    marketData: {
      ...
      body: "When Massachusetts small business owners were surveyed in 2025, the obstacle they named most often wasn't the economy and it wasn't funding. It was being unable to get clear, trusted information about what to do next. In a city like Chicopee, where the median household runs near $63,000 and every monthly bill gets weighed on its own merits, that gap costs money in one of two directions: you overpay an agency that quotes you in jargon you can't check, or you do nothing and stay invisible while a competitor doesn't. It's why our pricing is published, our plans are month-to-month, and we'll tell you when the $95 plan is all your business needs.",
