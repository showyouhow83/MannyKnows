...
export const localAreas: LocalArea[] = [
  ...
  },
  {
    ...
    beyondWeb: [
      ...
      },
      {
        ...
        body: 'Holyoke sits inside our free travel radius, so one professional 360° photo for your Google profile is free. We come to you.',
        href: '/local-seo/#free-360-photo',
        linkText: 'Claim the free photo',
      },
    ],
  ...
  },
  {
    ...
    offers: [
      {
        ...
        body: "Chicopee businesses earn their name the old way — good work, told neighbor to neighbor. We make sure the same name wins the new way too, with a fast site, built from scratch, that ranks when Fairview or the Falls goes searching.",
      },
      {
    ...
    faqDifferent:
      "The short version is enterprise engineering at family-business prices. Twenty years building for enterprise and startups, including enterprise eCommerce and consulting at Accenture, and when you call, you get the person doing the work, not an account manager between you and the answer.",
    servingBlurb:
      "Based in Springfield, right across the river, so it's easy to stop by in person and just as easy to handle remotely.",
    ...
    cityNow: {
      heading: 'Chicopee is building, and your storefront should too',
      paragraphs: [
  ...
  },
  {
    ...
    offers: [
      ...
      },
      {
        ...
        body: "Your city runs a municipal fiber network with 2.5-gig service. On connections that fast, a slow website has no excuse, so ours are engineered for top Lighthouse scores.",
      },
      {
    ...
    offers: [
      {
        ...
        body: "Agawam businesses run on reputation built over decades. We make the same name win the search with a fast site, built from scratch, ranking for what your neighbors actually type.",
      },
      {
