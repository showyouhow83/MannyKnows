...
export const plans: Plan[] = [
  {
    ...
    highlights: [
      ...
      'Hosting, SSL, and speed handled, with nothing extra to buy',
    ...
    deliverables: [
      {
        ...
        items: [
          'A private AI knowledge base of your business, covering services, prices, and voice',
      ...
      },
      {
        title: 'The website',
        items: [
          '1–3 focused pages designed and built for your business, not a template',
      ...
      },
      {
        ...
        items: [
          ...
          'Trained on your services, prices, hours, and how you talk',
      ...
      },
      {
        ...
        items: [
          'Run the site yourself and update pages, posts, photos, and prices without waiting on us',
          ...
          'We build it around your business, adding the sections you actually need (estimates, projects, contracts, portfolio) and leaving out the ones you don’t',
        ],
      },
      {
    ...
    steps: [
      { title: 'Kickoff', body: 'We learn what you do, who your customers are, and the questions they keep asking.' },
    ...
    deliverables: [
      ...
      },
      {
        ...
        items: [
          ...
          'Your admin grows with it — a calendar and availability you control, and a lead pipeline you can actually work',
        ],
      },
      {
        title: 'Getting found & kept running',
  ...
  },
  {
    ...
    deliverables: [
      ...
      },
      {
        ...
        items: [
          ...
          '360° image galleries and walkthroughs, so customers can step inside before they visit',
          'Google Search Console integration, with indexing and search performance watched against Google’s own data',
        ],
      },
      {
    ...
    steps: [
      { title: 'Kickoff', body: 'We take the time to really understand what you sell, who buys, how you sound, and what a good month looks like.' },
  ...
  },
  {
    ...
    deliverables: [
      ...
      },
      {
        ...
        items: [
          'A monthly working session on what the numbers say and what we change next',
          'A report of what ran, what it cost, and what it brought in',
          'Priority handling, so your requests go to the front of the line',
        ],
      },
    ],
    steps: [
  ...
  },
  {
    ...
    tiers: [
      ...
      },
      {
        ...
        features: [
          ...
          'Marketplace sync keeps catalog and inventory in step on Etsy, Amazon, or Square, so you sell everywhere without overselling anywhere',
    ...
    deliverables: [
      ...
      },
      {
        title: 'Your products',
        items: [
          'Products loaded, organized into collections, and kept current, with monthly change quotas by tier',
          'SEO product descriptions at every tier, drafted by AI from your product data and Brand Brain, then reviewed and optimized — your whole catalog, no per-product caps',
          'Your admin covers the store too, putting products, inventory, orders, and promos in one place',
        ],
      },
      {
        ...
        items: [
          ...
          'Email that brings people back, with flows from Sell More and monthly campaigns from Sell Smarter',
      ...
      },
      {
        ...
        items: [
          ...
          'A monthly report of what ran, what sold, and what changes next',
        ],
      },
    ],
    steps: [
  ...
  },
  {
    ...
    tiers: [
      ...
      },
      {
        ...
        features: [
          'One coordinated strategy across every network, while each still gets its own individual plan',
          'Cross-network reporting on what each network brings in, compared side by side',
    ...
    deliverables: [
      ...
      },
      {
        ...
        items: [
          ...
          'An AI-generated monthly report of what ran, what it cost, and what it brought in',
        ],
      },
    ],
    steps: [
  ...
  },
  {
    ...
    tiers: [
      {
        ...
        features: [
          ...
          'In constant contact through the workday, so every request gets a same-day answer, done that day or scheduled onto the roadmap',
          ...
          'Unlimited requests queued on the roadmap, and you set the priorities',
        ],
      },
      {
        name: 'Agency Monthly',
    ...
    deliverables: [
      ...
      },
      {
        ...
        items: [
          'Photography and videography, shot on scheduled shoot days for your business, products, and campaigns',
    ...
    steps: [
      ...
      { title: 'A shared roadmap', body: 'One prioritized queue across software, media, web, and promotion. Requests are unlimited, you set the order, and you always know what we’re building and why.' },
