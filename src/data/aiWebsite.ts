...
// What Remi does on THIS product. The agent is Remi — the same agent that
...
// starts at Get Booked $245/mo, selling at Get Growing; or hire Remi onto an
// existing site via the AI Team). Never claim booking here.
export const aiWebsiteAgent = [
  {
    title: 'Answers in your voice',
    body: "“Remi” is trained on your services, prices, and hours, so a customer at 11pm gets a real answer, not a contact form and a wait.",
  ...
  },
  {
    ...
    body: "English and Spanish are standard, not an add-on: “Remi” replies in whichever language the customer opens with, at whatever hour they show up.",
  ...
  },
  {
    ...
    body: "“Remi” answers and gathers; you close. And when you want it booking jobs or selling, the same “Remi” does that on the website plans: the training carries.",
...
// HONESTY GUARD: this Remi answers and captures the lead — it must NOT be
...
export const aiWebsiteMonthlyIncludes = [
  ...
  '“Remi” running, retrained whenever your prices, hours, or services change',
  'Every lead “Remi” captures, emailed to you as it happens',
...
export const aiWebsiteSetupIncludes = [
  ...
  '“Remi” trained on your services, prices, hours, and voice',
...
export const aiWebsiteSteps = [
  ...
  { title: '“Remi” learns your business', body: 'We train it on everything from step one and test it hard: you read how it answers before it ever talks to a customer.' },
...
export const aiWebsiteFaq = [
  ...
  },
  {
    ...
    a: "Then we embed them. Photos on your Google Business Profile live on Google's property: the tour on your own site is content under your domain, working for your rankings, with “Remi” right next to it ready to answer.",
  },
  {
  ...
  {
    q: 'Does “Remi” speak Spanish?',
    a: 'Yes. English and Spanish are standard on everything we build, never an add-on: “Remi” answers in whichever language the customer opens with.',
  },
  {
    q: 'What if I need more pages later?',
    a: `Nothing is wasted. The design, the copy, “Remi's” training, and your Google setup all carry into a bigger build or a monthly plan: you're moving up from what's already working, not starting over.`,
  },
];
...
export const aiWebsiteBlurb =
  `A fast one-page website with “Remi”, an AI agent that answers your customers and captures every lead, built around your business, tuned to near-perfect Google scores, and live on your own domain. $${aiWebsiteSetupFee} to build, $${aiWebsiteMonthly}/mo to run.`;
