    ...
    faqs: [
      {
        ...
        a: 'Our website plans start at $95/mo: a custom-designed 1–3 page site, hosting and SSL, “Remi” answering customers 24/7, Google Business Profile, technical SEO, and ongoing upkeep included. Month-to-month, nothing extra to start; prepay the year and you get 2 months free. A full multi-page site with “Remi” booking estimates for you is $245/mo, and every plan includes your own admin. Prefer a one-time build? We do that too, billed at a flat $75/hr and quoted up front.',
      },
      {
    ...
    faqs: [
      {
        ...
        a: 'Our website plans start at $95/mo: a custom-designed 1–3 page site, hosting and SSL, “Remi” answering parents 24/7, Google Business Profile, technical SEO, and upkeep included. Month-to-month, nothing extra to start; prepay the year and you get 2 months free. A full multi-page site with “Remi” booking tours for you starts at $245/mo, and every plan includes your own admin to track enrollment inquiries and update the site yourself. One-time builds are available too, billed at a flat $75/hr and quoted up front.',
      },
      {
