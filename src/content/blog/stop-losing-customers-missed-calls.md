...
The AI Sales & Booking Agent is built into our **[Smart Website plans](/plans/)** — a fast, multilingual website with Remi answering around the clock from $99/mo, and [booking appointments from $249/mo](/plans/get-booked/), kept trained and tuned every month. It's the difference between a website that just sits there and one that actually works your leads while you work the job.
