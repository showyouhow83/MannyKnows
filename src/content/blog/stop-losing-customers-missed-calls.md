...
The AI Sales & Booking Agent is built into our **[AI Smart Website plans](/plans/)** — a fast, multilingual website with Remi answering around the clock from $99/mo, and [booking appointments from $199/mo](/plans/plus-website/), kept trained and tuned every month. It's the difference between a website that just sits there and one that actually works your leads while you work the job.
