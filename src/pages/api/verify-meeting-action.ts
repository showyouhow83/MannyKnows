    ...
    return new Response(`
      ...
      <body>
        <div class="container">
          ...
          <p>If you have any questions, please contact us at <a href="mailto:mm@mannyknows.com">mm@mannyknows.com</a></p>
        </div>
      </body>
      </html>
    `, {
    ...
    return new Response(`
      ...
      <body>
        <div class="container">
          ...
          <p>There was an error processing your verification. Please contact support at mm@mannyknows.com if this issue persists.</p>
        </div>
      </body>
      </html>
    `, {
